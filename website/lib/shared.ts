...
export const siteUrl =
  process.env.NEXT_PUBLIC_SITE_URL || 'https://codespec.dev';

export const docsRoute = '/docs';
export const docsImageRoute = '/og/docs';
export const docsContentRoute = '/llms.mdx/docs';

// CodeSpec source repository, used for "edit this page" and GitHub links.
...
export const links = {
  ...
  npm: 'https://www.npmjs.com/package/@fission-ai/codespec',
  x: 'https://x.com/0xTab',
};

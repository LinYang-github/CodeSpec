...
/**
 * Returns the ids of active changes: every directory under codespec/changes/
 ...
 * Requiring proposal.md here made `codespec show` and shell completion miss
 * changes those commands resolve: `codespec new change <name>` scaffolds only
 * `.codespec.yaml`, and a custom schema need not define a proposal artifact at
 * all (#1161).
 */
 ...
 * codespec/changes/archive/ except hidden directories.
 *

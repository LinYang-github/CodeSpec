 ...
 * same field for Claude Code slash commands). Scoped to the CodeSpec CLI so
 * agents that honor it stop prompting on each `codespec` call; the field
 ...
 */
export const CODESPEC_CLI_ALLOWED_TOOLS = 'Bash(codespec:*)';

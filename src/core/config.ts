/** Canonical CodeSpec 1.0 workspace identity. */
export const CODESPEC_DIR_NAME = 'codespec';

/** Public Skills generated by CodeSpec 1.0. */
...
export const AI_TOOLS: AIToolOption[] = [
  ...
  { name: 'Hermes Agent', value: 'hermes', available: true, successLabel: 'Hermes Agent', skillsDir: '.hermes', detectionPaths: ['.hermes', 'HERMES.md', '.hermes.md'], setupNote: 'Hermes 默认只从 ~/.hermes/skills 加载技能。将本项目的 .hermes/skills 目录添加到 ~/.hermes/config.yaml 的 skills.external_dirs，使 Hermes 加载生成的 CodeSpec 技能。' },

...
async function readWorkspaceConfig(codespecDir: string): Promise<WorkspaceConfig> {
...
export async function loadWorkspace(codespecDir: string): Promise<WorkspaceContext> {

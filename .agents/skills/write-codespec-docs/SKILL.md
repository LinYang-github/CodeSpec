---
name: write-codespec-docs
description: Switches into CodeSpec docs-writing mode; loads the house style guide and drafts or revises pages in its voice (action-first, no preamble, scannable). Use when writing or editing pages in the CodeSpec docs tree.
argument-hint: page or section
---

# Write CodeSpec docs

You are now writing CodeSpec's user docs. Read [writing.md](writing.md); it is the style authority for everything drafted here. The short version, in effect immediately:
...
- Load the `no-ai-slop` skill before drafting; it owns the generic slop patterns, while [writing.md](writing.md) owns what CodeSpec's docs specifically look and sound like.

...
- [x] 5.1 Add Oh My Pi row to the tool directory reference table in `docs/supported-tools.md`: `| Oh My Pi (\`oh-my-pi\`) | \`.omp/skills/codespec-*/SKILL.md\` | \`.omp/commands/opsx-<id>.md\` |`

...
- Rename the entry to `Shared .agents skills`. The old label said "AGENTS.md", but CodeSpec writes no `AGENTS.md` — it strips its markers out of one.

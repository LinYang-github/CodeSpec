...
- [ ] 1.4 Extend `codespec config list` output to show install scope and source (`explicit`, `new-default`, `legacy-default`)
...
- [ ] 4.1 Add scope override flag to `codespec init` (`--scope global|project`)
...
- [ ] 5.1 Add scope override flag to `codespec update` (`--scope global|project`)
...
- [ ] 6.1 Extend `codespec config profile` interactive flow to select install scope

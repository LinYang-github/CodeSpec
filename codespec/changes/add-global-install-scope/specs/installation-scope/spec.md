...
Define the install scope model for CodeSpec-generated skills and commands, including scope preference, effective scope resolution, and fallback/error semantics.
...
- **AND** SHALL automatically remove only CodeSpec-managed files in the previous effective scope

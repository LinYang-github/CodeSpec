...
- **WHEN** a user runs `codespec instructions apply --change <id> --json`
...
- **WHEN** a user runs `codespec instructions apply --change <id>` with configured context and apply guidance

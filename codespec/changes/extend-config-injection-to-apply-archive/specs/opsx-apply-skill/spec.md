...
The `/opsx:apply` skill SHALL consume current project context and apply operation guidance returned by `codespec instructions apply --change "<name>" --json` while preserving its existing state-driven workflow.

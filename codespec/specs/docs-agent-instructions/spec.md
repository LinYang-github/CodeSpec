...
- **WHEN** `codespec/AGENTS.md` is regenerated or updated
...
`codespec/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`codespec/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `codespec validate`.
...
- **WHEN** reorganizing `codespec/AGENTS.md`
...
- **WHEN** `codespec/AGENTS.md` explains how to write `spec.md`

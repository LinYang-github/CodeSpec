...
## Purpose
Define tool-agnostic command content and adapter contracts for generating tool-specific CodeSpec command files.
...
- **THEN** `CommandContent` SHALL include:
  ...
  - `name`: human-readable name (e.g., 'CodeSpec Explore')
  - `description`: brief description of command purpose
  - `category`: grouping category (e.g., 'CodeSpec')

...
(`resolveCodeSpecRoot`, root-selection.ts). All nine resolution entry
...
the `~/codespec/<id>` checkout convention is 1 computed + 5 prose
...
- Whole delta: +29,468 / −23,327 across 235 files; the gross
  insertions are dominated by `codespec/work/` planning artifacts

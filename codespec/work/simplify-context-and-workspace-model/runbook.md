...
codespec/work/simplify-context-and-workspace-model/runbook.md (slice 1.4,
...
codespec/work/simplify-context-and-workspace-model/roadmap.md has all
...
- **Vocabulary**: new user-facing strings use only the locked nouns (store,
  reference, target project repo, CodeSpec root). One concept, one token —
  no synonym drift.

...
- Use repo-local CodeSpec changes for implementation plans owned by a repo or
  team.
...
- Use CodeSpec workspace commands instead of hand-editing
  `.codespec-workspace/*.yaml`.

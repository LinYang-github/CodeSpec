...
- Marked `codespec/changes/workspace-reimplementation-roadmap/START_HERE.md` as historical reference.
- Marked `codespec/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md` as historical reference.
- Marked `codespec/changes/workspace-reimplementation-roadmap/` as historical
  reference.
...
- `codespec validate workspace-reimplementation-roadmap --no-interactive`,
  `codespec validate workspace-apply-repo-slice --no-interactive`, and
  `codespec validate workspace-verify-and-archive --no-interactive` failed
...
- `codespec/changes/workspace-reimplementation-roadmap/START_HERE.md`
- `codespec/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md`
- `codespec/changes/workspace-reimplementation-roadmap/README.md`
- `codespec/changes/workspace-reimplementation-roadmap/proposal.md`
- `codespec/changes/workspace-reimplementation-roadmap/POC_REFERENCE_GUIDE.md`

Added a guard near the top of
`codespec/changes/workspace-reimplementation-roadmap/HISTORICAL_DIRECTION.md` stating
...
- No files under `codespec/specs/` or `schemas/workspace-planning/` were
...
- `codespec list` still shows deferred workspace changes as active no-task

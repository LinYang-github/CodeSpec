...
- `codespec/initiatives/context-store-and-initiatives/*.md`
- `codespec/initiatives/context-store-and-initiatives/work-items/**/*.md`
...
- `codespec/changes/workspace-reimplementation-roadmap/*`
- active `codespec/changes/workspace-*` proposals
- `docs/cli.md`
...
- Do not edit CodeSpec specs as part of the initial direction lock.

...
CodeSpec should keep the current boundary:
...
- route to narrower CodeSpec workflow skills when available.

As a temporary beta aid, a manual Codex skill was created at
`.codex/skills/use-codespec/` with references for shared context and artifact
